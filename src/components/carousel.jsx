...
const Carousel = () => {
  return (
    ...
    >
      {/* Text Section */}
      <div className="w-80% text-white bg-black/25 p-6 shadow-lg order-1 my-5">
      ...
      <div className="max-w-8xl w-7xl bg-white/20 backdrop-blur-md p-6 rounded-xl shadow-lg order-2">
